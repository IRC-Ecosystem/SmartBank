...
## Corpus Check
- 314 files · ~131,446 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2025 nodes · 3786 edges · 165 communities (116 shown, 49 thin omitted)
...
## Communities (165 total, 49 thin omitted)
...
Cohesion: 0.10
Nodes (12): FeeComponent, FeeQuote, FeeQuoteService, SOURCE_FEE_BY_APP, Injectable, FeeQuoteController, Controller, asJson() (+4 more)
...
Cohesion: 0.13
Nodes (16): AppError, STATUS_BY_CODE, ErrorCode, AuditLogService, Injectable, jsonSafe(), IdempotencyService, Injectable (+8 more)
...
Cohesion: 0.08
Nodes (9): ManagerService, Injectable, PrismaService, Injectable, TellerService, Injectable, Injectable, UPGRADEABLE_ROLES (+1 more)
...
Cohesion: 0.05
Nodes (52): OptionalAuthGuard, Injectable, RolesGuard, Injectable, ServiceTokenGuard, Injectable, AuditModule, Module (+44 more)

### Community 19 - "requestId"
Cohesion: 0.21
Nodes (13): CurrentUser, RequestUser, TellerController, Body, Controller, Param, Post, Req (+5 more)
...
Cohesion: 0.27
Nodes (11): requestHash(), requestId(), requireIdempotencyKey(), Roles(), CentralBankController, Body, Controller, Post (+3 more)
...
Cohesion: 0.39
Nodes (7): LoginDto, RegisterDto, IsNotEmpty, IsString, MaxLength, IsEmail, MinLength
...
Cohesion: 0.12
Nodes (17): devDependencies, jest, ts-jest, ts-node-dev, @types/bcrypt, @types/cors, @types/jest, @types/jsonwebtoken (+9 more)
...
Cohesion: 0.12
Nodes (15): CreatePaymentRequestDto, IsIn, IsNotEmpty, IsObject, IsOptional, IsString, Matches, MaxLength (+7 more)
...
Cohesion: 0.24
Nodes (6): PublicController, Controller, Get, PublicStats, PublicStatsService, Injectable
...
Cohesion: 0.16
Nodes (14): ApplyLoanDto, RepayLoanDto, IsNotEmpty, IsOptional, IsString, Matches, MaxLength, LoansController (+6 more)
...
Cohesion: 0.36
Nodes (5): AuthController, Body, Controller, Post, Req
...
## Knowledge Gaps
- **705 isolated node(s):** `ts`, `tsParser`, `name`, `version`, `private` (+700 more)
...
- **Why does `MoneyService` connect `MoneyService` to `settlement.service.ts`, `🔒 Production Hardening`, `PrismaService`, `.repay`, `SettlementService`, `app.module.ts`, `CurrentUser`, `MonetaryPolicyService`, `requireIdempotencyKey`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `PrismaService` connect `PrismaService` to `MoneyService`, `notification.controller.ts`, `settlement.service.ts`, `SettlementService`, `app.module.ts`, `public.module.ts`, `MonetaryPolicyService`, `.pendingLoans`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `CurrentUser` connect `requestId` to `notification.controller.ts`, `ApplyLoanDto`, `🔒 Production Hardening`, `.repay`, `CreatePaymentRequestDto`, `manager.controller.ts`, `CurrentUser`, `requireIdempotencyKey`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
