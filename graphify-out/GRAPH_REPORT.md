# Graph Report - SmartBank  (2026-07-20)

## Corpus Check
- 329 files · ~135,837 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2111 nodes · 3937 edges · 160 communities (112 shown, 48 thin omitted)
...
- `LoginPage()` --calls--> `useAuthStore`  [EXTRACTED]
  frontend/src/app/login/page.tsx → frontend/src/store/auth.ts
...
## Communities (160 total, 48 thin omitted)
...
Cohesion: 0.08
Nodes (11): DashboardPage(), AppShell(), badgeToneClasses, MenuItem, menus, OnboardingTour(), RolePage(), useIsClient() (+3 more)
...
Cohesion: 0.11
Nodes (16): Public(), FeeComponent, FeeQuote, FeeQuoteService, SOURCE_FEE_BY_APP, Injectable, FeeQuoteController, Body (+8 more)
...
### Community 6 - "env.ts"
Cohesion: 0.05
Nodes (45): adminRoutes, prisma, router, serviceSchema, healthRoutes, prisma, paymentSchema, paymentsRoutes (+37 more)
...
Cohesion: 0.07
Nodes (26): container, item, LoginPage(), LoginResponse, QUICK_ACCOUNTS, TONE_ACTIVE, container, item (+18 more)
...
Cohesion: 0.15
Nodes (11): AppError, STATUS_BY_CODE, ErrorCode, AuditLogService, Injectable, IdempotencyService, Injectable, LedgerPost (+3 more)

### Community 12 - "dependencies"
Cohesion: 0.06
Nodes (34): bcryptjs, dependencies, bcryptjs, cors, dotenv, express, jsonwebtoken, mysql2 (+26 more)

### Community 13 - "PrismaService"
Cohesion: 0.08
Nodes (14): TransfersController, Controller, Get, Query, TellerService, Injectable, Injectable, WalletAccountService (+6 more)

### Community 14 - "central-bank.ts"
Cohesion: 0.11
Nodes (24): metadata, DocumentKey, documents, SwaggerDocs(), auth, bodyOp(), centralBankSpec, financialAuth (+16 more)
...
Cohesion: 0.09
Nodes (19): generateAccountNumber(), isValidAccountNumber(), luhnChecksum(), AuthService, jsonSafe(), Injectable, asJson(), Get (+11 more)

### Community 18 - "app.module.ts"
Cohesion: 0.05
Nodes (50): OptionalAuthGuard, Injectable, RolesGuard, Injectable, ServiceTokenGuard, Injectable, AuditModule, Module (+42 more)

### Community 19 - "requestId"
Cohesion: 0.10
Nodes (36): CurrentUser, RequestUser, requestHash(), requestId(), requireIdempotencyKey(), CentralBankController, Body, Controller (+28 more)

### Community 20 - "manager.controller.ts"
Cohesion: 0.27
Nodes (8): Roles(), ManagerLoanActionDto, ManagerUserActionDto, IsNotEmpty, IsOptional, IsString, MaxLength, WalletsController
...
Cohesion: 0.10
Nodes (26): money(), Props, shortId(), WalletPicker(), WalletSummary, AdminAudit(), AuditLog, unwrap() (+18 more)
...
Cohesion: 0.10
Nodes (21): 🙏 Acknowledgments, 🔐 Akun Pengujian, 🏗️ Arsitektur, 💰 Aturan Finansial, 📑 Daftar Isi, Dengan Docker (direkomendasikan), 📚 Dokumentasi Service, Environment Variables (+13 more)
...
Cohesion: 0.10
Nodes (19): dependencies, cors, dotenv, express, http-proxy-middleware, jsonwebtoken, description, main (+11 more)
...
Cohesion: 0.11
Nodes (19): dependencies, clsx, driver.js, framer-motion, lucide-react, next, next-themes, react-dom (+11 more)

### Community 35 - "RetailDashboard.tsx"
Cohesion: 0.13
Nodes (18): ActiveLoan, AnimatedNumber(), BalanceInfo, formatAccountDisplay(), isCredit(), isValidAccountNumberFormat(), LoanLimit, LoanLimitCard() (+10 more)
...
Cohesion: 0.23
Nodes (13): countdown(), Filter, iconFor(), InboxContent(), secondsUntil(), NotificationBell(), Envelope, listNotifications() (+5 more)
...
Cohesion: 0.10
Nodes (19): dependencies, docx, description, devDependencies, concurrently, name, private, scripts (+11 more)

### Community 42 - "devDependencies"
Cohesion: 0.11
Nodes (19): devDependencies, jest, ts-jest, ts-node-dev, @types/bcrypt, @types/cors, @types/express, @types/jest (+11 more)
...
Cohesion: 0.38
Nodes (9): connector(), connectorUrl, crypto, gateway(), gatewayUrl, json(), link(), main() (+1 more)
...
Cohesion: 0.17
Nodes (12): scripts, build, db:setup, dev, prisma:generate, prisma:push, prisma:validate, seed:service-key (+4 more)
...
Cohesion: 0.29
Nodes (7): devDependencies, eslint, eslint-plugin-import, tsconfig-paths, eslint, eslint-plugin-import, tsconfig-paths
...
Cohesion: 0.19
Nodes (5): LoanService, Injectable, LoansController, Controller, Get

### Community 84 - "🚀 Quick Start (5 menit)"
Cohesion: 0.29
Nodes (6): FeeQuoteDto, IsIn, IsNotEmpty, IsString, Matches, MaxLength
...
Cohesion: 0.33
Nodes (5): Completed on 2026-07-20, Runtime validation pending, SmartBank Connector Completion Progress, Status: Implementation complete, live-stack validation pending, Verification results
...
Cohesion: 0.33
Nodes (5): Admin and security, Local setup (Terminal + Laragon), SmartBank Connector, Stack, Testing

### Community 102 - "Langkah 1 — Konfigurasi Environment"
Cohesion: 0.50
Nodes (3): migrate, server, { spawnSync, spawn }

### Community 103 - "Langkah 5 — Jalankan 4 Services"
Cohesion: 0.50
Nodes (3): Connector Security Audit, Implemented controls, Residual risks and deployment requirements
...
## Knowledge Gaps
- **741 isolated node(s):** `ts`, `tsParser`, `name`, `version`, `private` (+736 more)
...
- **Why does `PrismaService` connect `SettlementService` to `MoneyService`, `notification.controller.ts`, `settlement.service.ts`, `PrismaService`, `app.module.ts`, `RolesGuard`, `MonetaryPolicyService`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `RequestUser` connect `requestId` to `notification.controller.ts`, `settlement.service.ts`, `🔒 Production Hardening`, `PrismaService`, `RolesGuard`, `manager.controller.ts`, `CurrentUser`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `CurrentUser` connect `requestId` to `notification.controller.ts`, `settlement.service.ts`, `🔒 Production Hardening`, `PrismaService`, `RolesGuard`, `manager.controller.ts`, `CurrentUser`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
